...
('Bard', 'Leather', NULL, NULL),
('Bard', 'Dagger', NULL, NULL),
('Cleric', 'Mace', 'Warhammer', NULL),
('Cleric', 'Scale Mail', 'Leather', 'Chain Mail'),
...
('Ranger', 'Scale Mail', 'Leather', NULL),
...
('Entertainer', '15 gp', NULL, NULL, NULL),
...
('Folk Hero', '10 gp', NULL, NULL, NULL),
...
('Guild Artisan', '15 gp', NULL, NULL, NULL),
...
('Outlander', '10 gp', NULL, NULL, NULL),
...
INSERT INTO weapons
VALUES
('Club', 'Simple', 'Melee', '1d4 bludgeoning'),
('Dagger', 'Simple', 'Melee', '1d4 piercing'),
('Greatclub', 'Simple', 'Melee', '1d8 bludgeoning'),
('Handaxe', 'Simple', 'Melee', '1d6 slashing'),
('Javelin', 'Simple', 'Melee', '1d6 piercing'),
('Light Hammer', 'Simple', 'Melee', '1d4 bludgeoning'),
('Mace', 'Simple', 'Melee', '1d6 bludgeoning'),
('Quarterstaff', 'Simple', 'Melee', '1d6 bludgeoning'),
('Sickle', 'Simple', 'Melee', '1d4 slashing'),
('Spear', 'Simple', 'Melee', '1d6 piercing'),
('Unarmed Strike', 'Simple', 'Melee', '1 bludgeoning'),
('Light Crossbow', 'Simple', 'Ranged', '1d8 piercing'),
('Dart', 'Simple', 'Ranged', '1d4 piercing'),
('Shortbow', 'Simple', 'Ranged', '1d6 piercing'),
('Sling', 'Simple', 'Ranged', '1d4 bludgeoning'),
('BattleAxe', 'Martial', 'Melee', '1d8 slashing'),
('Flail', 'Martial', 'Melee', '1d8 bludgeoning'),
('Glaive', 'Martial', 'Melee', '1d10 slashing'),
('Greataxe', 'Martial', 'Melee', '1d12 slashing'),
('Greatsword', 'Martial', 'Melee','2d6 slashing'),
('Halberd', 'Martial', 'Melee', '1d10 slashing'),
('Lance', 'Martial', 'Melee', '1d12 piercing'),
('Longsword', 'Martial', 'Melee', '1d8 slashing'),
('Maul', 'Martial', 'Melee', '2d6 bludgeoning'),
('Morningstar', 'Martial', 'Melee', '1d8 piercing'),
('Pike', 'Martial', 'Melee', '1d10 piercing'),
('Rapier', 'Martial', 'Melee', '1d8 piercing'),
('Scimitar', 'Martial', 'Melee', '1d6 slashing'),
('Shortsword', 'Martial', 'Melee', '1d6 piercing'),
('Trident', 'Martial', 'Melee', '1d6 piercing'),
('War Pick', 'Martial', 'Melee', '1d8 piercing'),
('Warhammer', 'Martial', 'Melee', '1d8 bludgeoning'),
('Whip', 'Martial', 'Melee', '1d4 slashing'),
('Blowgun', 'Marital', 'Ranged', '1 piercing'),
('Hand Crossbow', 'Marital', 'Ranged', '1d6 piercing'),
('Heavy Crossbow', 'Marital', 'Ranged', '1d10 piercing'),
('Longbow', 'Marital', 'Ranged', '1d8 piercing'),
('Net', 'Marital', 'Ranged', '-');
...
values
('Dwarf', 'Tool Proficiency: Smith''s tools, brewer''s supplies or mason''s tools'),
('Dwarf', 'Languages: Common and Dwarvish'),
('Elf', 'Languages: Common and Elvish'),
('Halfling', 'Languages: Common, Halfling'),
('Human', 'Languages: Common and one other'),
('Dragonborn', 'Languages: Common and Draconic'),
('Gnome', 'Languages: Common and Gnomish'),
('Half-Orc', 'Languages: Common and Orc'),
('Tiefling', 'Languages: Common and Infernal'),
...
('Bard', 'Tool prof: Three Musical Instruments of your choice'),
...
('Druid', 'Tool prof: Herbalism kit'),
('Fighter', 'All armor, shields'),
('Fighter', 'Simple Weapons, martial weapons'),
('Monk', 'Simple weapons, shortswords'),
('Monk', 'Choose one artisan tools or musical instrument'),
...
('Guild Artisan', 'One type of artisans tool'),
('Guild Artisan', 'One language of your choice'),
('Hermit', 'Herbalism kit'),
('Hermit', 'One language of your choice'),
('Noble', 'One type of gaming set'),
('Noble', 'One language of your choice'),
('Outlander', 'One type of music instrument'),
('Outlander', 'One language of your choice'),
('Sage', 'Two languages of your choice'),
('Sailor', 'Navigators tools, vehicles(water)'),
...
('Dwarf', 'Dwarvern Combat Training'),
('Dwarf', 'Stonecunning'),
('Elf', 'Darvision'),
('Elf', 'Keen Senses'),
('Elf', 'Fey Ancestry'),
...
('Halfling', 'Lucky'),
('Halfing', 'Brave'),
('Halfing', 'Halfling Nimbleness'),
('Dragonborn', 'Dragonic Ancestry'),
